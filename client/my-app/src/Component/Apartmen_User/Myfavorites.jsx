        ...
        <div className="card flex justify-content-center flex-wrap gap-3">
            ...
            {myapartments.map((apartment) => (
                <Card
                    ...
                    title={`דירה ב${apartment.apartment.city}`}
                    subTitle={`שכונה: ${apartment.apartment.neighborhood || 'לא צוינה'}, רחוב: ${apartment.street}, מספר: ${apartment.building}`}
                    footer={
            ...
            >
                ...
                {selectedApartment && (
                    <div>
                        {console.log(selectedApartment.options)}
